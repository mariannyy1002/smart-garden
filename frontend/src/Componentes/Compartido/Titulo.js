...
export default class Titulo extends Component {
    render() {
        ...
        if (this.props.lugar) {
            var boton = <h1 className="py-2 px-3 mr-0 mt-2 bd-highlight btn btn-success text-center font-weight-bold" data-bs-toggle="modal" data-bs-target="#modal-agregar"><i className="me-1 fas fa-plus"></i> Agregar {this.props.lugar}</h1>
        ...
        if (this.props.alertas > 0) {
            var alertas = <><i className="me-3 fas fa-exclamation-triangle"></i>{this.props.alertas}</>;
        }
        return (
